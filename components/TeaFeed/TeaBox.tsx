    ...
    return (
        <div className="bg-white rounded-xl m-2 md:mx-6 p-2 grid grid-cols-teabox gap-4">
            ...
            <form className="grid grid-rows-teabox gap-2" action="" >
                {/* <div> */}
                <textarea className="p-2 border-none resize-none text-xl md:text-2xl text-gray-gray font-semibold focus:outline-none" placeholder="What's the tea?" value={input} onChange={e => setInput(e.target.value)} />
                {/* </div> */}
